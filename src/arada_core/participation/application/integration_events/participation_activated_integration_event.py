...
class ParticipationActivatedIntegrationEvent:
    """
    Contrato público de integración para una Participation activada.

    Este Integration Event:

    - representa un hecho de dominio ya confirmado;
    - deriva explícitamente de ParticipationActivated;
    - es inmutable;
