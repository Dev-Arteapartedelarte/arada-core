...
class ProposalSubmittedForIntegration:
    """
    Contrato de integración derivado del hecho confirmado ProposalSubmitted.
    ...
    El contrato conserva además el contexto mínimo necesario de la Proposal
    ...
    - el Aggregate Proposal completo;
    - ProposalName;
    - ProposalPurpose;
    - ProposalDescription;
    - ProposalContent;
    ...
    - representaciones FIWARE;
    - representaciones NGSI-LD.
